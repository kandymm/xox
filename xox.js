...
function startGame(){
 ...
 blocks.forEach(block => block.addEventListener('click', () => chooseAreas(block )));
    }
    
    function chooseAreas(block) {
        ...
        if(block.textContent ==="")  {
           ...
           errorText.textContent= "Hey it is not empty";
    ...
    if(gameOver){
        ...
        blocks.forEach(block => block.style.pointerEvents = 'none'); // oyun bitnce işartelemeye devam etmez
    }
};
